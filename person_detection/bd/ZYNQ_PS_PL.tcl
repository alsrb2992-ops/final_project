...
################################################################
# This is a generated script based on design: ZYNQ_PS_PL
#
...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:user:PL_PS_1myip:1.0\
...
proc create_root_design { parentCell } {
  ...
  set sio_c [ create_bd_port -dir O sio_c ]
  set sio_d [ create_bd_port -dir IO sio_d ]

  # Create instance: PL_PS_1myip_0, and set properties
  set PL_PS_1myip_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:PL_PS_1myip:1.0 PL_PS_1myip_0 ]
  ...
  connect_bd_intf_net -intf_net PL_PS_1myip_0_M00_AXIS [get_bd_intf_pins PL_PS_1myip_0/M00_AXIS] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_pins PL_PS_1myip_0/S00_AXI] [get_bd_intf_pins smartconnect_0/M01_AXI]
  ...
  connect_bd_net -net Net [get_bd_ports sio_d] [get_bd_pins PL_PS_1myip_0/sio_d]
  connect_bd_net -net PL_PS_1myip_0_sio_c [get_bd_ports sio_c] [get_bd_pins PL_PS_1myip_0/sio_c]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net cam_d_0_1 [get_bd_ports cam_d] [get_bd_pins PL_PS_1myip_0/cam_d]
  connect_bd_net -net cam_href_0_1 [get_bd_ports cam_href] [get_bd_pins PL_PS_1myip_0/cam_href]
  connect_bd_net -net cam_pclk_0_1 [get_bd_ports cam_pclk] [get_bd_pins PL_PS_1myip_0/cam_pclk]
  connect_bd_net -net cam_vsync_0_1 [get_bd_ports cam_vsync] [get_bd_pins PL_PS_1myip_0/cam_vsync]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins PL_PS_1myip_0/m00_axis_aresetn] [get_bd_pins PL_PS_1myip_0/s00_axi_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins smartconnect_1/aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins PL_PS_1myip_0/m00_axis_aclk] [get_bd_pins PL_PS_1myip_0/s00_axi_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PL_PS_1myip_0/S00_AXI/S00_AXI_reg] -force
