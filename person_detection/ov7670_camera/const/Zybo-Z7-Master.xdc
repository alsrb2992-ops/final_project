...
set_property -dict { PACKAGE_PIN H17   IOSTANDARD TMDS_33     } [get_ports hdmi_tx_clk_n];  # HDMI TX Clock (Differential)
set_property -dict { PACKAGE_PIN H16   IOSTANDARD TMDS_33     } [get_ports hdmi_tx_clk_p];
set_property -dict { PACKAGE_PIN D20   IOSTANDARD TMDS_33     } [get_ports {hdmi_tx_n[0]}]; # HDMI TX Data Channel 0 (Blue)
set_property -dict { PACKAGE_PIN D19   IOSTANDARD TMDS_33     } [get_ports {hdmi_tx_p[0]}];
set_property -dict { PACKAGE_PIN B20   IOSTANDARD TMDS_33     } [get_ports {hdmi_tx_n[1]}]; # HDMI TX Data Channel 1 (Green)
set_property -dict { PACKAGE_PIN C20   IOSTANDARD TMDS_33     } [get_ports {hdmi_tx_p[1]}];
set_property -dict { PACKAGE_PIN A20   IOSTANDARD TMDS_33     } [get_ports {hdmi_tx_n[2]}]; # HDMI TX Data Channel 2 (Red)
