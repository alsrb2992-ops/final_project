...
##LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { brake_gpio }]; #IO_L23P_T3_35 Sch=led[0]
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { led_rpi_active }]; #IO_L23N_T3_35 Sch=led[1]
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { led_cnn_active }]; #IO_0_35 Sch=led[2]
#set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { car_control[3] }]; #IO_L3N_T0_DQS_AD1N_35 Sch=led[3]
...
##Pmod Header JA (XADC)
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { pwm_servo  }]; #IO_L21P_T3_DQS_AD14P_35 Sch=JA1_R_p		   
# set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports {  }]; #IO_L22P_T3_AD7P_35 Sch=JA2_R_P             
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { bluetooth_rx }]; #IO_L24P_T3_AD15P_35 Sch=JA3_R_P            
set_property -dict { PACKAGE_PIN K14   IOSTANDARD LVCMOS33 } [get_ports { lidar_rx }]; #IO_L20P_T3_AD6P_35 Sch=JA4_R_P             
...
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33     } [get_ports { dir_dc[0]  }]; #IO_L15P_T2_DQS_13 Sch=jb_p[1]		 
set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33     } [get_ports { dir_dc[1]  }]; #IO_L15N_T2_DQS_13 Sch=jb_n[1]         
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33     } [get_ports {  pwm_dc }]; #IO_L11P_T1_SRCC_13 Sch=jb_p[2]        
...
##Pmod Header JC                                                                                                                  
# set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33     } [get_ports {  }]; #IO_L10P_T1_34 Sch=jc_p[1]   			 
# set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33     } [get_ports {  }]; #IO_L10N_T1_34 Sch=jc_n[1]		     
# set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33     } [get_ports {} ]; #IO_L1P_T0_34 Sch=jc_p[2]              
...
##Pmod Header JD                                                                                                                  
# set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33     } [get_ports {   }]; #IO_L5P_T0_34 Sch=jd_p[1]                  
# set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33     } [get_ports { uart_tx_pin }]; #IO_L5N_T0_34 Sch=jd_n[1]				 
...
##Pmod Header JE                                                                                                                  
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { uart_tx_pin }]; #IO_L4P_T0_34 Sch=je[1]						 
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { wifi_tx }]; #IO_L18N_T2_34 Sch=je[2]                     
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { rpi_signal }]; #IO_25_35 Sch=je[3]                          
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { cnn_signal }]; #IO_L19P_T3_35 Sch=je[4]                     
...
# set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { wifi_tx }]; #IO_L7N_T1_34 Sch=je[10]                    
