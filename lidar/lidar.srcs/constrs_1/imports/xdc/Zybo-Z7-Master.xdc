...
# set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { fifo_full_led }]; #IO_L3N_T0_DQS_AD1N_35 Sch=led[3]
...
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { wifi_tx }]; #IO_L24P_T3_AD15P_35 Sch=JA3_R_P            
...
##Pmod Header JC                                                                                                                  
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33     } [get_ports { direction_degree_gpio[0] }]; #IO_L10P_T1_34 Sch=jc_p[1]   			 
set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33     } [get_ports { direction_degree_gpio[1] }]; #IO_L10N_T1_34 Sch=jc_n[1]		     
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33     } [get_ports { direction_degree_gpio[2] }]; #IO_L1P_T0_34 Sch=jc_p[2]              
...
# set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { lidar_rx }]; #IO_L19P_T3_35 Sch=je[4]                     
